...
private fun HomeScreenPreview() {
    HomeScreen(
        uiState = HomeUiState(
            ...
            welcomeMessage = "?ΩÏ?Î°?Í∏∞Î°ù?òÎäî ?òÎßå???¨Ï†ï",
            highlights = listOf(
                HomeHighlight("?§Îäò???òÏä§??, "?úÎç§ ?§Ìèø 3Í≥?Î∞©Î¨∏"),
                HomeHighlight("?àÎì† Ï±åÎ¶∞ÏßÄ", "ÎπÑÎ? Ï∫êÎ¶≠???òÏßë"),
                HomeHighlight("Ï£ºÍ∞Ñ ??Çπ", "?ÅÏúÑ 10% ÏßÑÏûÖ ?ÑÏ†Ñ")
            )
        ),
        onRefreshHighlights = {}
    )
